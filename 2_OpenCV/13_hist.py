...
hist_gray = cv2.calcHist([img_gray],[0],None,[256],[0,256]) # 이미지 리스트(여러 이미지 가능), 채널
...
for channel_idx, channel_name in zip(channel_indices, channel_names):
    hist = cv2.calcHist([img_color],[channel_idx],None,[256],[0,256])
